...
public class StoryboardProgression : MonoBehaviour {
    ...
    void Update()
    {
        ...
        else if (Input.GetKeyDown(KeyCode.Alpha2) && sceneIDs.Length > 1)
            SceneManager.LoadScene(sceneIDs[1]);
        else if (Input.GetKeyDown(KeyCode.Alpha3) && sceneIDs.Length > 2)
            SceneManager.LoadScene(sceneIDs[2]);
        else if (Input.GetKeyDown(KeyCode.Alpha4) && sceneIDs.Length > 3)
            SceneManager.LoadScene(sceneIDs[3]);
        else if (Input.GetKeyDown(KeyCode.Alpha5) && sceneIDs.Length > 4)
